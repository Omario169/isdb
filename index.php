...
<main>
    ...
    <section class="hero-area">
        <div class="hero-slides owl-carousel">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="300ms">The Fall of Hobo Johnson <span>The Fall of Hobo Johnson</span></h2>
            ...
            <div class="single-hero-slide d-flex align-items-center justify-content-center">
                <!-- Slide Img -->
                <div class="slide-img bg-img" style="background-image: url(img/bg-img/wt10.jpg);"></div>
                <!-- Slide Content -->
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-slides-content text-center">
                                <h6 data-animation="fadeInUp" data-delay="100ms">Newest Episode</h6>
                                <h2 data-animation="fadeInUp" data-delay="300ms">Scale or Die <span>Scale or Die</span></h2>
                                <a data-animation="fadeInUp" data-delay="500ms" href="#" class="btn oneMusic-btn mt-50">Discover <i class="fa fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    <div class="featured-artist-content">
                        ...
                        <div class="section-heading white text-left mb-30">
                            ...
                            <h2>The Feral Kings</h2>
                        </div>
                        <p>Manchester based band.</p>
                        <div class="song-play-area">
                            <div class="song-name">
                                <p>01. Fizzy Soda</p>
                            </div>
                            <audio preload="auto" controls>
                                <source src="audio/fizzy-soda.mp3">
                            </audio>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="popular-artists-area mb-100">
                        <div class="section-heading text-left mb-50 wow fadeInUp" data-wow-delay="50ms">
                            <p>Learn more about your favourite content creators</p>
