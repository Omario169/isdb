...
//   while($dataR= $sqlGetComment->fetch_assoc())
...
if (isset($_POST['addComment'])) {
  ...
  if ($isReply) {
    ...
    $sqlGetComment = $conn->query("SELECT user_comment_table.comment_id, uidUsers, message, DATE_FORMAT(user_comment_table.created_on, '%Y-%m-%d') 
